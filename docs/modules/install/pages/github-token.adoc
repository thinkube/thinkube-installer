...
* If you keep a metadata repository named `<your username>-metadata` with your own templates, the installer reads it and clones the templates marked for development into the IDE.
